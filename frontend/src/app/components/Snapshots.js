...
//   const [isDarkMode] = useState(true);
  ...
  return (
    ...
    //   </div>
    // </div>
    <ComingSoon featureName={"Snapshots Feature Coming Soon"} featureDescription={"We're working hard to bring you automated deployment snapshots with version control. This feature will be available in our next update."} isDarkMode={isDarkMode}/>
  );
};
